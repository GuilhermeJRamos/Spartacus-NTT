export const myAccount = {
  /**
   * @deprecated desde a versão 4.2, use a biblioteca de recursos @spartacus/order/assets em vez disso
   */
  orderDetails: {
    orderId: 'Pedido nº',
    orderNumber: 'Número do Pedido',
    replenishmentId: 'Reabastecimento nº',
    purchaseOrderId: 'Ordem de Compra nº',
    ...
    statusDisplay_merchant: {
      approved: 'Aprovado pelo Comerciante',
      rejected: 'Rejeitado pelo Comerciante',
    },
    ...
    consignmentTracking: {
      ...
      dialog: {
        ...
        noTracking:
          'O pacote não foi despachado do depósito. As informações de rastreamento estarão disponíveis após o envio do pacote.',
    ...
    cancelReplenishment: {
      ...
      reject: 'Não',
      cancelSuccess:
        'O pedido de reabastecimento nº{{replenishmentOrderCode}} foi cancelado com sucesso',
    },
  },
  /**
   * @deprecated desde a versão 4.2, use a biblioteca de recursos @spartacus/order/assets em vez disso
  ...
  orderHistory: {
    ...
    replenishmentOrderId: 'Reabastecimento nº',
    purchaseOrderNumber: 'Nº da Ordem de Compra',
    startOn: 'Iniciar em',
    frequency: 'Frequência',
    nextOrderDate: 'Próxima Data do Pedido',
    cancel: 'Cancelar',
  ...
  closeAccount: {
    confirmAccountClosure: 'Confirmar Fechamento da Conta',
    confirmAccountClosureMessage:
      'Tem certeza de que deseja fechar sua conta?',
    closeMyAccount: 'FECHAR MINHA CONTA',
    accountClosedSuccessfully: 'Conta fechada com sucesso',
    accountClosedFailure: 'Falha ao fechar a conta',
  },
  ...
  updatePasswordForm: {
    ...
    bothPasswordMustMatch: 'Ambas as senhas devem corresponder',
  ...
  consentManagementForm: {
    ...
    message: {
      success: {
        given: 'Consentimento concedido com sucesso.',
  ...
  myCoupons: {
    ...
    effectiveTitle: 'Eficaz:',
    Effective: 'EFICAZ',
    PreSession: 'EFICAZ EM BREVE',
   ...
   */
  returnRequest: {
    returnRequestId: 'Pedido de Devolução nº',
    orderCode: 'Para o Pedido nº',
    ...
    cancelSuccess: 'Seu pedido de devolução ({{rma}}) foi cancelado',
  },
  wishlist: {
