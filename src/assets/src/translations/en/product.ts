export const product = {
  ...
  productSummary: {
    ...
    showReviews: 'Mostrar avaliações',
    showReviewsDetailed:
      'Mostrar {{count}} avaliações, Avaliado com {{rating}} de 5 estrelas',
    share: 'Compartilhar',
  ...
  productReview: {
    ...
    thankYouForReview:
      'Obrigado pela avaliação! Observe que as avaliações podem exigir revisão antes de aparecerem aqui.',
  },
  addToCart: {
  ...
  stockNotification: {
    ...
    notified: 'Você será notificado quando este produto estiver de volta em estoque.',
    getNotified: 'Seja notificado quando este produto estiver de volta em estoque.',
    unsubscribeSuccess:
      'Você não receberá mais notificações de disponibilidade deste produto.',
    subscriptionDialog: {
      header: 'Inscrição fora de estoque',
      notifiedPrefix: 'Você será notificado em:',
      notifiedSuffix: 'assim que este produto estiver de volta em estoque.',
      ...
      manageSubscriptionsPrefix: 'Você pode gerenciar suas inscrições em ',
      manageSubscriptionsLink: 'Meus Interesses',
      manageSubscriptionsSuffix: ' página.',
      okBtn: 'OK',
      subscribing:
        'Inscrição para notificações de fora de estoque para este produto',
    },
  },
  itemCounter: {
  ...
  productView: {
    gridView: 'Selecionar para mudar para a Visualização de Grade',
    listView: 'Selecionar para mudar para a Visualização de Lista',
  },
};
